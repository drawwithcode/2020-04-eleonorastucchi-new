...
background(h, s, b);
  ...
  p2.position(windowWidth / 2.7, windowHeight * 9.3 / 10);

  p3 = createP("Hue");
  p3.position(windowWidth / 150, windowHeight * 3.3 / 20);

  p4 = createP("Saturation");
  p4.position(windowWidth / 150, windowHeight * 6.3 / 20);

  p5 = createP("Brightness");
  p5.position(windowWidth / 150, windowHeight * 9.3 / 20);

  p6 = createP("Circles");
  p6.position(windowWidth / 150, windowHeight * 12.3 / 20);
